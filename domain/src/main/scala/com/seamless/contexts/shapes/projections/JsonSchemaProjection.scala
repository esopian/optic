...
import com.seamless.contexts.shapes.ShapesHelper.{BooleanKind, ListKind, MapKind, NullableKind, NumberKind, ObjectKind, OptionalKind, ReferenceKind, StringKind}
import com.seamless.contexts.shapes.{ShapesHelper, ShapesState}
import com.seamless.contexts.shapes.projections.FlatShapeProjection.{FlatShape, FlatShapeResult}
